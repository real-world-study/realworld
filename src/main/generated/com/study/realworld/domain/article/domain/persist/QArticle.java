...
public class QArticle extends EntityPathBase<Article> {
    ...
    public final com.study.realworld.domain.article.domain.vo.QArticleTags articleTags;
    ...
    public QArticle(Class<? extends Article> type, PathMetadata metadata, PathInits inits) {
        ...
        this.articleTags = inits.isInitialized("articleTags") ? new com.study.realworld.domain.article.domain.vo.QArticleTags(forProperty("articleTags")) : null;
