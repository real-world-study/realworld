...
(
    ...
    CONSTRAINT fk_comment_to_airticle_id FOREIGN KEY (airticle_id) REFERENCES article (id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    user_id         bigint          NOT NULL,
    airticle_id     bigint          NOT NULL,
    PRIMARY KEY (user_id, airticle_id),
    CONSTRAINT fk_favorite_to_user_id FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE ,
    CONSTRAINT fk_favorite_to_airticle_id FOREIGN KEY (airticle_id) REFERENCES article (id) ON DELETE CASCADE
);
