...
public class UnFavoriteInfo {
    ...
    public static UnFavoriteInfo of(final Article article, long favoritesCount, boolean following) {
        ...
        return new UnFavoriteInfo(
                articleSlug, articleTitle, articleDescription,
                articleBody, tagNames, createdAt, updatedAt, false, favoritesCount, authorInfo);
    }
