...
public class CustomUserDetailsService implements UserDetailsService {
  ...
  public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
    User user = userService.findByEmail(new Email(email)).orElseThrow(IllegalArgumentException::new);
  ...
  private org.springframework.security.core.userdetails.User generateSecurityUser(Email email, String password, final SimpleGrantedAuthority authority) {
