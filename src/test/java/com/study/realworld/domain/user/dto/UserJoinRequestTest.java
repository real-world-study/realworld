...
import static com.study.realworld.domain.user.domain.UserTest.USERNAME;
...
public class UserJoinRequestTest {
    ...
    void constructor_test() {
        final UserJoinRequest userJoinRequest = new UserJoinRequest(USERNAME, new Email(EMAIL), PASSWORD);
    ...
    public static final UserJoinRequest userJoinRequest(final String username, final Email email, final String password) {
